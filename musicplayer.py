...
canvas = tk.Tk()
canvas.title("spotify without the good")
canvas.geometry("600x800")
canvas.config(bg="black")

path = "C:/Users/ashis/Downloads/songs"
pattern = "*.mp3"
...
listBox = tk.Listbox(canvas, fg="cyan", bg="black", width=100, font=("Gotham-bold", 14))
listBox.pack(padx=15, pady=15)

label = tk.Label(canvas, text="", bg="black", fg="yellow", font=("Gotham-bold", 18))
label.pack(pady=15)
